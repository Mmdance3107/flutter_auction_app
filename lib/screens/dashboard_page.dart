...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Future<List<GridItem>> getAuctionStatistics() async {
    ...
    List<GridItem> gridItems = [
      ...
      GridItem(Icons.assignment_outlined, 'Currently running Number of auctions', stats[1].toString()),
      GridItem(Icons.brightness_high_outlined, 'Total Number of Completed auctions', stats[2].toString()),
      GridItem(Icons.price_change_rounded, 'Total completed Auctions Value Amount', stats[3].toString()),
    ];
